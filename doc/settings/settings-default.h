...
/*
 *	Questo si tratta del file di impostazioni di default di corredo
 *  al sistema.
 *
 *  Nel caso in cui si fosse perso il vecchio file e si volesse ripristinare
 *  i valori di default e' possibile utilizzare il seguente file
 *  
